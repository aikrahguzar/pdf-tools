...
* Note: I am moving future development to https://codeberg.org/rahguzar/pdf-tools

Please file any issues or pull requests there. This repository will see updates only as needed to collaborate with pdf-tools upstream.
